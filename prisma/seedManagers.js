...
const managersSansara = [
    { name: "Сторожук", id: "1385", priority: 2, active: true },
    { name: "Максимова Людмила", id: "332", active: true },
    { name: "Бочарникова", id: "1767", active: true },
    { name: "Трофимов", id: "1140", priority: 2, active: true },
    { name: "Бородина", id: "353", priority: 2, active: true },
    ...
    { name: "Найданова", id: "190", priority: 1, active: true },
        ...
        if (existingManager) {
            ...
            await db.activeManagers.update({
                ...
                data: {
                    ...
                    sansara_priority: manager.priority ? manager.priority : 3
                 },
            });
        } else {
