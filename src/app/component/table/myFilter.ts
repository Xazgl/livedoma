...
export const columnsSetsApplication: GridColDef[][] = [
  [
    ...
    // { field: "", headerName: "Комментарий", width: 200 },
    // { field: "", headerName: "Статус", width: 200 },
  ],  [
...
export const columnsSets2: GridColDef[][] = [
  ...
  [
    { field: "agentSellerName", headerName: "Агент покупателя", width: 200 },
  ...
  [
    { field: "agentBuyerName", headerName: "Агент продав", width: 200 },
