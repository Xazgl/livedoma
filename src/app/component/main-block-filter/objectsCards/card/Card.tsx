...
import DynamicCardImg from "./card-img/DynamicCardImg";
import { useTheme } from "../../../provider/ThemeProvider";
import React from "react";
import { getValidImageSrc } from "./card-img/utils";
          ...
          <div className="flex  flex-col  w-[auto]  h-[100%]    md:justify-around">
            <div className="flex   w-[100%] h-[200px] sm:w-[300px]  sm:h-[260px]   lg:w-[400px] lg:h-[98%]  relative overflow-hidden">
              <Link href={`/object/${object.id}`} className="w-[100%] h-[100%]">
                ...
                <DynamicCardImg
                  alt={object.category}
                  src={getValidImageSrc(object)}
                />
              </Link>
              {loadingImg == false && (
                <div className="flex absolute w-[100%] justify-end p-[4px]">
                  {favorites.find((obj) => obj.object.id === object.id) ? (
                    <FavoriteIcon
                      sx={{
                        background: "#80757529",
                        display: "flex",
              ...
              >
                ...
                <p className="flex text-[#9da1ab] text-[13px]  md:text-[16px]">
                  {`${object.state}, ${object.city},${
                    object.street == "Не указана" ? "" : `, ${object.street}`
                  }`.length > 70
                    ? `${`${object.state}, ${object.city} ${
