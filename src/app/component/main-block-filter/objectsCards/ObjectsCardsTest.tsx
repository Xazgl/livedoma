...
import { addToFavorite, deleteFavorite, getFavorite } from "@/lib/favoriteFunc";
...
export function ObjectsCardsTest({
  ...
  // "flex-col items-center  h-[100vh]  justify-center  flex-nowrap"
  // :
  // "flex-col  md:items-center md:items-start   h-full    "
                ...
                >
                  ...
                  >
                    <div className="flex  flex-col  w-[auto]  h-[100%]    md:justify-around">
                      <div className="flex   w-[100%] h-[200px] sm:h-[250px]  md:w-[312px]  md:h-[70%]    relative">
                        ...
                        {loadingImg == false && (
                          <div className="flex absolute w-[100%] justify-end p-[4px]">
                            {favArr.find((obj) => obj.object.id === object.id) ? (
                              <FavoriteIcon
                                sx={{
                                  display: "flex",
                      ...
                      <div className="hidden md:flex  mt-[5px] w-[100%] md:w-[312px] h-[50px] md:h-[60px]  justify-between sm:mt-[10px] ">
                        {object.img.slice(1, 4).map((image, index) => (
                          <div
                            key={index}
                            className="flex h-[50px] w-[95px] md:h-[60px] md:w-[100px] relative"
                          >
                            <Image
                              className="rounded"
                              src={image}
                    ...
                    <div className="flex mt-[5px] gap-[5px] md:mt-[0px] flex-col  w-full  h-full   items-start md:gap-[20px] text-black">
                      ...
                      <h3 className="flex md:hidden w-full text-sm  text-black gap-[5px] items-center">
                        ...
                        {object.rooms
                          ? `${object.rooms} ${getRoomsEnding(object.rooms)}`
                          : null}
                      </h3>
