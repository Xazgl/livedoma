...
const rawLeads = [{
    ...
    utm_content: "",
    utm_term: "",
    text: "Сколько комнат в Вашей квартире? '1-комнатная', Укажите площадь квартиры '30', Укажите этаж квартиры '3', Какие в квартире дополнительные помещения? 'Кладовая', Санузлы в квартире 'Смежный', Состояние квартиры 'Жилое состояние', Укажите адрес квартиры 'Канатчиков 17'"
},
{
    phone: "79219543067",
    name: "Елена",
    ...
    utm_content: "",
    utm_term: "",
    text: "Квиз от 01.07.2025, Сколько комнат в Вашей квартире? '1-комнатная', Укажите площадь квартиры '31', Укажите этаж квартиры '4', Какие в квартире дополнительные помещения? 'Балкон', Санузлы в квартире 'Смежный', Состояние квартиры 'Жилое состояние', Укажите адрес квартиры 'Богунская 29'"
}]
