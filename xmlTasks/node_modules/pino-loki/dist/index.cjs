...
var _propsToLabels, _levelMap, _buildTimestamp, buildTimestamp_fn, _buildLabelsFromProps, buildLabelsFromProps_fn;
...
class LogBuilder {
  ...
  build(log, replaceTimestamp, additionalLabels) {
    ...
    const time = __privateMethod$1(this, _buildTimestamp, buildTimestamp_fn).call(this, log, replaceTimestamp);
    const propsLabels = __privateMethod$1(this, _buildLabelsFromProps, buildLabelsFromProps_fn).call(this, log);
